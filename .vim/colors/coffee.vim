...
" NOTE: setting cterm to NONE removes the background color for
" transparent terminals
let s:black           = { "gui": "NONE", "cterm": "NONE"   }
let s:dark            = { "gui": "#222222", "cterm": "0"   }
let s:medium_gray     = { "gui": "#767676", "cterm": "8" }
let s:white           = { "gui": "#F5F5F5", "cterm": "7"  }
...
let s:dark_green      = { "gui": "#00FECA", "cterm": "6"   }
let s:light_green     = { "gui": "#00FECA", "cterm": "6"  }
let s:dark_purple     = { "gui": "#523C79", "cterm": "5"   }
let s:light_purple    = { "gui": "#6855DE", "cterm": "5"  }
let s:light_yellow    = { "gui": "#F57C00", "cterm": "3"  }
let s:dark_yellow     = { "gui": "#795548", "cterm": "3"   }
...
if &background == "dark"
  ...
  let s:cursor_line     = s:light_blue
  let s:status_line     = s:medium_gray
...
call s:h("ConstantString",      {"bg": s:bg, "fg": s:dark_yellow})
hi! link Character        Constant
hi! link Number           Constant
hi! link Boolean          Constant
hi! link Float            Constant
hi! link String           ConstantString
...
if has("gui_running")
  ...
  call s:h("SpellCap",    {"gui": "underline", "sp": s:dark_yellow})
  call s:h("SpellRare",   {"gui": "underline", "sp": s:pink})
  call s:h("SpellLocal",  {"gui": "underline", "sp": s:dark_green})
else
  call s:h("SpellBad",    {"cterm": "underline", "fg": s:red})
  call s:h("SpellCap",    {"cterm": "underline", "fg": s:dark_yellow})
